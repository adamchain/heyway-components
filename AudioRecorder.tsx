...
import { HEYWAY_SPACING, HEYWAY_TYPOGRAPHY, HEYWAY_RADIUS, HEYWAY_COLORS, HEYWAY_SHADOWS, HEYWAY_ACCESSIBILITY } from '@/styles/HEYWAY_STYLE_GUIDE';
...
const IOS_COLORS = {
  ...
  text: {
    primary: HEYWAY_COLORS.text.inverse,
    secondary: HEYWAY_COLORS.text.secondary,
    tertiary: HEYWAY_COLORS.text.tertiary,
  },
  accent: HEYWAY_COLORS.interactive.primary,
  success: HEYWAY_COLORS.status.success,
  error: HEYWAY_COLORS.status.error,
  separator: HEYWAY_COLORS.border.tertiary,
};
