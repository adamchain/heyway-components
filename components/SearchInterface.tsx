      ...
      <View style={styles.contactResultContent}>
        <View style={styles.contactInfo}>
          <View style={styles.contactIcon}>
            <User size={20} color={HEYWAY_COLORS.text.secondary} />
          </View>
        ...
        <View style={styles.callIconContainer}>
          <Phone size={16} color={HEYWAY_COLORS.accent.info} />
        </View>
      </View>
    </TouchableOpacity>
  );
    ...
    <View style={styles.bottomSearchContainer}>
      <View style={styles.searchInputContainer}>
        <View style={styles.searchIcon}>
          <Search size={20} color={HEYWAY_COLORS.text.tertiary} />
        </View>
        <TextInput
        ...
        {isNumberInput && searchQuery.length >= 10 && (
          ...
          >
            <Phone size={18} color={HEYWAY_COLORS.background.primary} />
          </TouchableOpacity>
        )}
      </View>
