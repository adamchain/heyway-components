...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    ...
    borderRadius: HEYWAY_SPACING.xl,
  ...
  headerButton: {
    width: HEYWAY_SPACING.xxxl + HEYWAY_SPACING.xs,
    height: HEYWAY_SPACING.xxxl + HEYWAY_SPACING.xs,
  ...
  textInput: {
    ...
    fontSize: HEYWAY_TYPOGRAPHY.fontSize.body,
    color: HEYWAY_COLORS.text.primary,
    minHeight: HEYWAY_SPACING.xxxxl + HEYWAY_SPACING.xs,
  },
  textArea: {
    minHeight: HEYWAY_SPACING.giant * 2,
    textAlignVertical: 'top',
  ...
  removeChipButton: {
    width: HEYWAY_SPACING.lg + HEYWAY_SPACING.xs,
    height: HEYWAY_SPACING.lg + HEYWAY_SPACING.xs,
    borderRadius: HEYWAY_RADIUS.md,
    backgroundColor: HEYWAY_COLORS.background.primary,
    alignItems: 'center',
    justifyContent: 'center',
